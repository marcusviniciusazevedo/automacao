# Automações para tarefas
Exercícios em criação de automações para um relatório enviado por e-mail, análise de cotação, processo seletivo de RH e artigos para grupo de Telegram integados com planilhas do Google.
